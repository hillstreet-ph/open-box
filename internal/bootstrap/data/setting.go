...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems := []model.SettingItem{
		...
		{Key: conf.SiteTitle, Value: "Open-Box", MigrationValue: "OpenList", Type: conf.TypeString, Group: model.SITE},
		{Key: conf.Announcement, Value: "Welcome to Open-Box — your unified, non-destructive storage hub. Connect multiple cloud accounts from the integration settings and keep every source organized in its own mount.", MigrationValue: "Welcome to the OpenList project!\nFor the latest updates, to contribute code, or to submit suggestions and issues, please visit our [project repository](https://github.com/OpenListTeam/OpenList).", Type: conf.TypeText, Group: model.SITE},
		...
		// style settings
		{Key: conf.Logo, Value: "https://open-box.space/open-box-brand.svg", MigrationValue: "https://res.oplist.org/logo/logo.svg", Type: conf.TypeText, Group: model.STYLE},
		{Key: conf.Favicon, Value: "https://open-box.space/open-box-brand.svg", MigrationValue: "https://res.oplist.org/logo/logo.svg", Type: conf.TypeString, Group: model.STYLE},
		{Key: conf.MainColor, Value: "#7c3aed", MigrationValue: "#1890ff", Type: conf.TypeString, Group: model.STYLE},
